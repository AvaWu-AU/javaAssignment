...
//This class is created for building B-tree index

public class BtreeIndex<Key extends Comparable<Key>, Value> {
	
	private static final int NODE_MAX_CHILD = 27; //max children in each b-tree node = M-1
	...
	private static final class Node{
		...
		private Entry[] children = new Entry[NODE_MAX_CHILD]; //array for storing children
